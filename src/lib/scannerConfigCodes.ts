 ...
 *   Asclion capture les scans via 6 chemins parallèles passifs (uiohook, Raw
 *   Input N-API, node-hid, WebHID, SerialPort, UI Automation watcher). Le
 *   scanner peut rester dans son mode USB-Keyboard par défaut : aucune
 *   reconfiguration n'est requise dans 95% des cas.
 *
