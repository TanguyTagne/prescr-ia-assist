  ...
  return (
    <>
      <button
        ...
        aria-label={open ? "Fermer la démo Asclion" : "Ouvrir la démo Asclion"}
      ...
      {open && (
        ...
        >
          <div className="pharmacy-gradient px-3 py-1.5 flex items-center gap-2 sticky top-0 z-10">
            ...
            <span className="text-[10px] font-medium text-primary-foreground/80 uppercase tracking-wider">Démo</span>
          </div>
